...
|--------|----------|-----|--------|
| Учебные PDF | Project Context | 🚀 | Прямой поиск по тексту |
| Главы 1-20 | Загружены в чат | 🚀 | Поиск по номеру/теме |
| Оглавление | `Оглавление.pdf` | ⚡ | Структура курса |
| Индекс | `Предметный указатель.pdf` | 🚀 | Быстрый поиск терминов |
